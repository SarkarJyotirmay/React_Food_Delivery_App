...
import { displayCart, addFirst, increaseQuantity, decreaseQuantity } from "../../store/slices/cartSlice";
    ...
    <div className={styles["single-food-item"]}>
      ...
      <div className={styles.info}>
        ...
        <div className={styles["cart-actions"]}>
          <h3>$ {obj.price}</h3>
          <button onClick={()=>navigate("/cart")} className={styles["add-to-cart"]}>Go To Cart</button>
